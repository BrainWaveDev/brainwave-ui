...
const ActionsPopover = () => (
  <Popover.Root>
    <Popover.Trigger asChild>
      <button
        className="font-base text-gray-600 rounded-lg text-sm px-3 py-1.5 inline-flex shadow items-center justify-center bg-white hover:bg-teal-50/[0.5] cursor-pointer outline-none"
