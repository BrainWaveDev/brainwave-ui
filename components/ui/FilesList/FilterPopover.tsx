...
const FilterPopover = () => (
  <Popover.Root>
    <Popover.Trigger asChild>
      <button
        className="rounded-full w-[35px] h-[35px] inline-flex shadow items-center justify-center text-gray-600 bg-white hover:bg-teal-50/[0.5] cursor-pointer outline-none mr-4"
